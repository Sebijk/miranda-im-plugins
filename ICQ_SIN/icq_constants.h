...
/* Mod Static icon indexes */
#define ISI_SET_VIS                 4
#define ISI_SET_INVIS               5
#define ISI_SCAN                    6
...
/* Mod Contact menu item indexes */
#define ICMI_SET_VIS                5
#define ICMI_SET_INVIS              6
#define ICMI_SCAN                   8
...
//mod options
#define DEFAULT_IDS                 0
#define DEFAULT_INVISIDS            0
#define DEFAULT_LCN                 0 //LeaveChatNotify
#define DEFAULT_FORCEXSTATUS        1
#define DEFAULT_INVALIDSMR          1
#define DEFAULT_MALURL              0
#define DEFAULT_XTRAZMETHOD         1
#define DEFAULT_ADDEDMETHOD         0
#define DEFAULT_MALCON              0
#define DEFAULT_IDSICON             0
#define DEFAULT_IDSDIM             1
#define DEFAULT_NEWSMS              1
#define DEFAULT_NOSMSPROFILE        0
...
#define MTYPE_AUTOONLINE            0xE7 // Auto away message
...
#define ICQ_PLUG_VERSION            0x8005005D
