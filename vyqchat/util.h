...
#define util_loc2utf(a)	mir_utf8encode(a)
#define util_utf2loc(a) mir_u2a(mir_utf8decodeW(a))
#define util_loc2uni(a)	mir_a2u(a)
#define util_uni2loc(a)	mir_u2a(a)
#define util_utf2uni(a)	mir_utf8decodeW(a)
#define util_uni2utf(a)	mir_utf8encodeW(a)
